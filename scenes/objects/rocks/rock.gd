...
var stone_scene = preload("res://scenes/objects/rocks/stone.tscn") #get stone from file path
...
func on_max_damage_reached() -> void:
	call_deferred("add_stone_scene") #on next frame
	queue_free()
	
func add_stone_scene() -> void:
	var stone_instance = stone_scene.instantiate() as Node2D #create stone
